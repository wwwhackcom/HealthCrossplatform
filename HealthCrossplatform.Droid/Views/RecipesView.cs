...
namespace HealthCrossplatform.Droid.Views
{
    ...
    [Register("healthCrossplatform.droid.views.RecipesView")]
    public class RecipesView : BaseFragment<RecipesViewModel>
    {
        protected override int FragmentId => Resource.Layout.RecipesView;

        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            var view = base.OnCreateView(inflater, container, savedInstanceState);

            ParentActivity.SupportActionBar.Title = Strings.Recipes;
